 ...
 *
 */
public class IconTextView_user_complete extends LinearLayout {
     ...
     * TextView 03
     */
    private TextView mText03,mText04,mText05,mText06,mText07,mText08;

    public IconTextView_user_complete(Context context, IconTextItem_user_complete aItem) {
        super(context);

        // Layout Inflation
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        inflater.inflate(R.layout.user_list_item_complete, this, true);
        ...
        mText08 = (TextView) findViewById(R.id.user_complete_date);
        mText08.setText(aItem.getData(6));
