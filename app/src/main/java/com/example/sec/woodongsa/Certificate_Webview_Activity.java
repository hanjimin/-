...
public class Certificate_Webview_Activity extends Activity {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url){
            ...
            if(url.startsWith("http://woodongsa.com/app/app_register_step3.php") || url.startsWith("http://woodongsa.cafe24.com/app/app_register_step3.php")){
                ...
                if(result != null && result.equals("Y")){
                    ...
                    Toast.makeText(Certificate_Webview_Activity.this,"실패하였습니다",Toast.LENGTH_SHORT).show();
                }
                return false;
            }
...
public boolean onOptionsItemSelected(MenuItem item) {
    ...
    switch (item.getItemId()) {
        case android.R.id.home:
            Intent intent = new Intent(Certificate_Webview_Activity.this, Select_Service_Activity.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(intent);
            finish();
            return true;
