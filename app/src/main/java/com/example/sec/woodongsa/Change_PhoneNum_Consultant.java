...
public class Change_PhoneNum_Consultant extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_change__phone_num__consultant);
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if ((keyCode == KeyEvent.KEYCODE_BACK)) {
                    ...
                    if(webView.canGoBack()){
                        ...
                        Intent intent = new Intent(Change_PhoneNum_Consultant.this, Mypage_consultant.class);
        ...
        class LoginAsync extends AsyncTask<String, Void, String> {
            ...
            protected void onPostExecute(String result){
                ...
                if(s.equalsIgnoreCase("success")){
                    ...
                    Intent intent = new Intent(getApplicationContext(),Mypage_consultant.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    intent.putExtra("current_mypage_tab_num",1);
                    finish();
                    startActivity(intent);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case android.R.id.home:
                Intent intent = new Intent(Change_PhoneNum_Consultant.this, Select_Service_Activity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
                finish();
                return true;
